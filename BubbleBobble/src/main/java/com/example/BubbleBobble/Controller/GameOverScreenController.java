...
/**
 * The class, GameOverController, is the controller for GameOverScreen, and is linked with GameOverScreen.fxml
 * The GameOver screen contains information:
 * <ol>
 *     <li>GameOver title</li>
 *     <li>current score</li>
 *     <li>current level</li>
 * </ol>
 * And the Game Over screen contains several functionalities and entry:
 * <ol>
 ...
 * </ol>
 * The GameOver screen also includes some of the validation because it involves writing data to the file, which means
...
public class GameOverScreenController {
    ...
    public void initialize() {
        ...
        CurrentScore.setText(Integer.toString(userHolder.getUserSetting().getScore()));
        CurrentLevel.setText(Integer.toString(userHolder.getUserSetting().getLevel()));
    }
     ...
     */
    public void OnNewGameButtonClicked(MouseEvent mouseEvent) throws IOException {
        UserHolder userHolder = UserHolder.getInstance();
        String name = null;
     ...
     * @param mouseEvent click the button
     */
    public void OnGameOverQuitButtonClicked(MouseEvent mouseEvent) {
        UserHolder userHolder = UserHolder.getInstance();
        String name = null;
        if (NameInput.getText().trim().isEmpty()) {
            Random r = new Random();
